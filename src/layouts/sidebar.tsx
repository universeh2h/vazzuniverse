...
import { ArrowDown, Calculator, Gamepad2, ListOrdered, LogOut, Search, X } from "lucide-react"
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex items-center justify-between p-4 border-b">
          <div className="flex items-center space-x-2">
            <Image
              src={(URL_LOGO as string) || "/placeholder.svg?height=40&width=40"}
              height={40}
              width={40}
          ...
          <Button onClick={onClose} size="sm" variant="ghost" className="h-8 w-8 p-0" aria-label="Close sidebar">
            <X className="h-4 w-4" />
          </Button>
        </div>
        ...
        <div className="flex-1 overflow-auto py-4">
          <nav className="space-y-1 px-2">
            ...
            <SidebarLink href="/daftar-harga" icon={<ListOrdered className="h-4 w-4" />}>
              Daftar Harga
            </SidebarLink>
            ...
            <div className="py-1">
              ...
              >
                ...
                <ArrowDown className={`h-4 w-4 transition-transform ${openCalculator ? 'rotate-180' : ''}`} />
              </button>
              
              {openCalculator && (
                <div className="mt-1 ml-7 space-y-1 border-l-2 pl-3">
                  <SidebarLink href="/calculator/winrate">
                    WinRate
                  </SidebarLink>
                  <SidebarLink href="/calculator/magic-wheel">
                    Magic Wheel
                  </SidebarLink>
                  <SidebarLink href="/calculator/zodiac">
                    Zodiac
                  </SidebarLink>
                </div>
              )}
